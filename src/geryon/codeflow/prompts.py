...
- `submit(title, description, rationale, code, refines=None)`: run the final script AND store it as a hypothesis. Call this when you are confident. You may submit multiple times.
