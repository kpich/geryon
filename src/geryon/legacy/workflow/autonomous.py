...
from geryon.legacy.llm.critic import HypothesisCritic
from geryon.legacy.llm.generator import HypothesisProposal
from geryon.legacy.llm.narrator import ResultNarrator
from geryon.legacy.llm.prompts import PROPOSAL_SYSTEM_PROMPT
from geryon.llm.provider import create_provider
from geryon.legacy.llm.ranker import HypothesisRanker
...
from geryon.legacy.tools.derived import create_derived_view
from geryon.legacy.tools.volcano import scan_groupby
from geryon.legacy.workflow.context import (
        ...
        def submit_hypothesis_tool(
            ...
            try:
                ...
                if self.llm_logger:
                    ...
                    self.llm_logger.log_proposal(
                        idx=len(submitted),
                        cohort_a=proposal.cohort_a_description,
                        cohort_b=proposal.cohort_b_description,
                        filters_a=[
                            f.model_dump() for f in spec.query.cohort_a.filters
                        ],
                        filters_b=[
                            f.model_dump() for f in spec.query.cohort_b.filters
                        ],
                    )
